    ...
    for player in attack_team_players:
        ...
        for position in player_positions:
            ...
            if position == "GK":
                ...
                parameters["BallLosePass_AtkDef_l"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
                ...
                parameters["BallLosePass_AtkDef_cl"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
                ...
                if parameters["ShortPass_AtkDef_cl"] == 0:
                    ...
                    parameters["BallLosePass_AtkDef_cr"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
                ...
                parameters["BallLosePass_AtkDef_r"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
                ...
                parameters["LoseBall_AtkMidBwd_cl"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
                ...
                if parameters["ShortPass_AtkMidBwd_cl"] == 0:        
                    ...
                    parameters["LoseBall_AtkMidBwd_cr"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
                ...
                parameters["LoseBall_AtkMidFwd_rl"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
                ...
                parameters["LoseBall_AtkMidFwd_c"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
                ...
                parameters["LoseBall_AtkMidFwd_lr"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
                ...
                parameters["Heading_AtkFor_LR"] = float(player["attacking_heading_accuracy"])
                parameters["LoseBall_AtkFor_LR"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
                ...
                parameters["Heading_AtkFor_C"] = float(player["attacking_heading_accuracy"])
                parameters["LoseBall_AtkFor_C"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
                ...
                parameters["Heading_AtkFor_RL"] = float(player["attacking_heading_accuracy"])
                parameters["LoseBall_AtkFor_RL"] = (float(player["defending_standing_tackle"]) + float(player["defending_sliding_tackle"]) + float(player["mentality_interceptions"])) / 3
